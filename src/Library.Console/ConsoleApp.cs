  ...
  async Task<ConsoleState> SearchBooks()
{
    ...
    // Find BookItems for this book, then check if any are on loan
    Loan? loan = _jsonData.Loans?.FirstOrDefault(l => 
        _jsonData.BookItems?.Any(bi => bi.Id == l.BookItemId && bi.BookId == book.Id) == true 
        && l.ReturnDate == null);
